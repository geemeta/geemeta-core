 ...
 * @date 2017/5/30.
 */
public class SQLTemplateManager extends Manager {
    private Logger logger = LoggerFactory.getLogger(SQLTemplateManager.class);
    ...
    public void parseStream(InputStream is) throws IOException {
        compileJs(sqlTemplateParser.parse(readLines(is)));
    }
