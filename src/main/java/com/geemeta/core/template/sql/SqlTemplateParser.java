 ...
 * @date 2017/6/1.
 */
public class SqlTemplateParser extends AbstractParser<SqlTemplateLexer> {
    private static Logger logger = LoggerFactory.getLogger(SqlTemplateParser.class);
    ...
    @Override
    public Class<SqlTemplateLexer> getLexerType() {
        return SqlTemplateLexer.class;
    }
