...
public class ShiroDbRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        List<String> permissionTexts = dao.queryForOneColumnList(shiroUser.loginName, String.class);
        List<String> roles = dao.queryForOneColumnList(String.class,"loginName",shiroUser.loginName);
